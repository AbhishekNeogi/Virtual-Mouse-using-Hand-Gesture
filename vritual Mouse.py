                ...
                for point in mp_hands.HandLandmark:
                    ...
                    if point == 'HandLandmark.INDEX_FINGER_TIP':
                        try:
                            ...
                            win32api.SetCursorPos((indexfingertip_x*4,indexfingertip_y*3))
                        ...
                        try:
                            ...
                            pass
                    try :
                        Distance_x = sqrt(abs((indexfingertip_x)**2-(thumbfingertip_x)**2))
                        Distance_y = sqrt(abs((indexfingertip_y)**2-(thumbfingertip_y)**2))
                        dist = int(sqrt((indexfingertip_x-thumbfingertip_x)**2+(indexfingertip_y-thumbfingertip_y)**2))
                        print(dist)
